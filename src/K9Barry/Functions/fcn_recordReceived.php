 ...
 * @return void
 */
function fcn_recordReceived($db_conn, $db_incident, $strInFile, $logger)

{
    ...
    if ($xml->ClosedFlag == "true") { //record is closed
        ...
        fcn_insertRecord($db_conn, $db_incident, $xml, $send = 0, $logger); // Record exists in DB-check for changes to in fields
    }
}
