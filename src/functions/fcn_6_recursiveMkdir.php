 ...
 * @param object|null $logger Logger instance for directory creation operations
 ...
 */
function fcn_6_recursiveMkdir(string $dest, ?object $logger = null, int $permissions = 0755, bool $recursive = true): bool
{
